...
(function(h, f) {
    ...
    if (document.addEventListener) {
        h.each(["mouseover", "mousedown", "mouseup", "click"],
        function(p, q) {
            document.addEventListener(q, l, true)
        })
    }
})(jQuery); (function(i, n, o, h) {
    ...
    c.classes.Frame = function(ae, af, B) {
        ...
        V.attachShow = function(s, aj) {
            ...
            if (aa.display !== "inline") {
                if (w && s.is("input")) {
                    s.prop("readonly", true).on("mousedown.dw",
                    function(ak) {
                        ak.preventDefault()
                    })
                }
        ...
        V.show = function(aj, s) {
            ...
            if (X) {
                i(n).on("keydown", ac);
                if (aa.scrollLock) {
                    ab.on("touchmove mousewheel wheel",
                    function(al) {
                        if (C) {
                            al.preventDefault()
                        }
                ...
                if (l && Z && !aj) {
                    ab.addClass("dw-in dw-trans").on(f,
                    function() {
            ...
            V.position();
            r.on(R, v);
            ab.on("selectstart mousedown", g).on("click", ".dwb-e", g).on("keydown", ".dwb-e",
            function(al) {
                if (al.keyCode == 32) {
                    al.preventDefault();
                    al.stopPropagation();
            ...
            i("input,select,textarea", ab).on("selectstart mousedown",
            function(al) {
                al.stopPropagation()
            }).on("keydown",
            function(al) {
            ...
            function(am, al) {
                V.tap(i(".dwb" + am, ab),
                function(an) {
                    al = d(al) ? V.buttons[al] : al; (d(al.handler) ? V.handlers[al.handler] : al.handler).call(this, an, V)
                },
                true)
            });
        ...
        V.hide = function(s, aj, ak, al) {
            ...
            if (ab) {
                ...
                if (l && X && Z && !s && !ab.hasClass("dw-trans")) {
                    ab.addClass("dw-out dw-trans").on(f,
                    function() {
                        ad(s)
                    }).find(".dw").addClass("dw-" + Z)
                } else {
...
})(jQuery, window, document); (function(h, k, l, f) {
    var c = h.mobiscroll,
    g = c.classes,
    i = c.util,
    b = i.jsPrefix,
...
})(jQuery, window, document); (function(b, c) {
    var a = b.mobiscroll;
    a.datetime = {
        defaults: {
            shortYearCutoff: "+10",
    ...
    c.presets.scroller.select = function(M) {
        ...
        return {
            ...
            onMarkupReady: function(i) {
                ...
                d(".dwwl" + O, i).on("mousedown touchstart",
                function() {
                    clearTimeout(J)
                });
                d(".dwwl" + q, i).on("mousedown touchstart",
                function() {
                    if (!D) {
                        clearTimeout(J)
                    }
